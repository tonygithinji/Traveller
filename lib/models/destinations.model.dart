...
List<Destination> destinations = [
  Destination(
    ...
    city: 'Venice',
    country: 'Italy',
    description: 'Visit Venice for an amazing and unforgettable experience',
  ...
  Destination(
    ...
    city: 'Sao Paulo',
    country: 'Brazil',
    description: 'Visit Sao Paulo for an amazing and unforgettable experience',
    activities: activities,
  ),
  Destination(
    ...
    city: 'Paris',
    country: 'France',
    description: 'Visit Paris for an amazing and unforgettable experience',
    activities: activities,
  ),
];
